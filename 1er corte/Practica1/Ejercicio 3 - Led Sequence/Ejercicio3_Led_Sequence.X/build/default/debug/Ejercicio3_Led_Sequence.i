# 1 "Ejercicio3_Led_Sequence.asm"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 296 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Ejercicio3_Led_Sequence.asm" 2
...
; Descripción: Generación de 4 secuencias o efectos distintosusando 4 o más leds,
...
; la velocidad de ejecución dela secuencia.
