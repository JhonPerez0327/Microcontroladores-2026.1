...
FINAL_IMAGE=${DISTDIR}/Led_boton.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=Led_boton.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Led_boton.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Led_boton.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Led_boton.o

# Source Files
SOURCEFILES=Led_boton.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Led_boton.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F4550
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Led_boton.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Led_boton.o: Led_boton.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Led_boton.o 
	${MP_AS} -mcpu=PIC18F4550 -c \
	-o ${OBJECTDIR}/Led_boton.o \
	Led_boton.asm \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Led_boton.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F4550 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Led_boton.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
