...
# 36 "oled_4sensores.c"
void I2C_Delay(){ _delay((unsigned long)((5)*(8000000/4000000.0))); }

void I2C_Start(){
    TRISBbits.TRISB0 = 0; TRISBbits.TRISB1 = 0;
    LATBbits.LATB0 = 1; LATBbits.LATB1 = 1; I2C_Delay();
    LATBbits.LATB0 = 0; I2C_Delay();
    LATBbits.LATB1 = 0;
}
...
void I2C_Stop(){
    TRISBbits.TRISB0 = 0;
    LATBbits.LATB0 = 0;
    LATBbits.LATB1 = 1; I2C_Delay();
    LATBbits.LATB0 = 1; I2C_Delay();
}
...
unsigned char I2C_Write(unsigned char data){
    ...
    for(char i = 0; i < 8; i++){
        TRISBbits.TRISB0 = 0;
        LATBbits.LATB0 = (data & 0x80) ? 1 : 0;
        LATBbits.LATB1 = 1; I2C_Delay();
        LATBbits.LATB1 = 0; I2C_Delay();
        data <<= 1;
    }
...
unsigned char I2C_Read(unsigned char ultimo){
    ...
    for(char i = 0; i < 8; i++){
        dato <<= 1;
        LATBbits.LATB1 = 1; I2C_Delay();
        if(PORTBbits.RB0) dato |= 1;
        LATBbits.LATB1 = 0; I2C_Delay();
    }
    TRISBbits.TRISB0 = 0;
    LATBbits.LATB0 = ultimo ? 1 : 0;
    LATBbits.LATB1 = 1; I2C_Delay();
    LATBbits.LATB1 = 0; I2C_Delay();
    return dato;
}
...
unsigned int ADC_ReadAvg(unsigned char c){
    ...
    return (unsigned int)(s / 8);
}
# 436 "oled_4sensores.c"
...
void main(){
    ...
    while(1){
        ...
        LATDbits.LATD0 = (t_adc >= 60 && t_adc <= 80);
        LATDbits.LATD1 = (l_adc > 500);
        LATDbits.LATD2 = (a_adc > 400);
